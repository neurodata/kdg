    ...
    for train_index, test_index in skf.split(X, y):
        ...
        for jj,sample in enumerate(sample_size):
            ...
            for ii in range(reps):
                ...
                model_rf = rf(n_estimators=n_estimators, max_depth=max_depth).fit(X_train[train_idx], y_train[train_idx])
                ...
                model_kdf = kdf({'n_estimators':n_estimators, 'max_depth':max_depth})
