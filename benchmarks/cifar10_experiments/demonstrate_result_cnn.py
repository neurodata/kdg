...
for seed in seeds:
    ...
    with open('/Users/jayantadey/kdg/benchmarks/cifar10_experiments/results/resnet50_cifar10_'+str(seed)+'.pickle','rb') as f:
    ...
    with open('/Users/jayantadey/kdg/benchmarks/cifar10_experiments/results/resnet50_cifar10_ODIN_'+str(seed)+'.pickle', 'rb') as f:
        (proba_in_odin, proba_cifar100_odin, proba_svhn_odin, proba_noise_odin) = pickle.load(f)

    with open('/Users/jayantadey/kdg/benchmarks/cifar10_experiments/results/resnet50_cifar10_OE_'+str(seed)+'.pickle', 'rb') as f:
