...
tasks = [3,6,11,12,14,16,18,22,23,28,31,32,37,43,45,
49,53,219,2074,3022,3549,3560,3902,3903,3913,3917,3918,9946,
9952,9957,9960,9964,9971,9978,
9985,10093,10101,14952,14965,14969,167141]
reps = 5
samples = []
samples_normalized = []
delta_kappas = []
...
plt.savefig('plots/openML_cc18_all_amalgamated_activation2.pdf')
#plt.show()