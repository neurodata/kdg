...
df.to_csv('high_dim_res_kdf_gaussian_empirical_cov.csv')
# %% plot the result
import pandas as pd
...
filename1 = 'high_dim_res_kdf_gaussian_empirical_cov.csv'
...
plt.savefig('plots/high_dim_gaussian_empirical_cov.pdf')
