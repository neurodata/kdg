...
#%%
dataset_id = 44#44#11#22#11#40979#1067#1468#44#40979#1468#11#44#1050#
...
#%%
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=1000, train_size=3000, random_state=10, stratify=y)
